CREATE TABLE `silvan`.`subcategory` (
`id` INT NOT NULL AUTO_INCREMENT,
`value` varchar(100) CHARACTER SET utf8 NOT NULL,
UNIQUE KEY `value_UNIQUE` (`value`),
PRIMARY KEY (`id`));

INSERT INTO `silvan`.`subcategory` VALUES
(1, "trafficJam"),
(2, "carAccident"),
(3, "carWrongDirection"),
(4, "carStopped"),
...
CREATE TABLE `silvan`.`category` (
`id` INT NOT NULL AUTO_INCREMENT,
`value` varchar(100) CHARACTER SET utf8 NOT NULL,
UNIQUE KEY `value_UNIQUE` (`value`),
PRIMARY KEY (`id`));

INSERT INTO `silvan`.`category` VALUES
(1, "traffic"),
(2, "naturalDisaster"),
(3, "weather"),
(4, "environment"),
...
CREATE TABLE `silvan`.`severity` (
`id` INT NOT NULL AUTO_INCREMENT,
`value` varchar(100) CHARACTER SET utf8 NOT NULL,
UNIQUE KEY `value_UNIQUE` (`value`),
PRIMARY KEY (`id`));

INSERT INTO `silvan`.`severity` VALUES
(1, "informational"),
(2, "low"),
(3, "medium"),
(4, "high"),
...
CREATE TABLE `silvan`.`relational` (
`id` INT NOT NULL AUTO_INCREMENT,
...
INSERT INTO `silvan`.`relational` (id, id_subcategory, id_category) VALUES
(1,1,1),
(2,2,1),
(3,3,1),
(4,4,1),
...
CREATE TABLE `silvan`.`tree_frames_update` (
`id` INT NOT NULL AUTO_INCREMENT,
`frame` INT,
`greenPixels` FLOAT(4),
`dryPixels` FLOAT(4),
`dateProcessed` DATE NOT NULL,
`timeProcessed` TIME (0) NOT NULL,
`dateRecorded` DATE NOT NULL,
`timeRecorded` TIME (0) NOT NULL,
